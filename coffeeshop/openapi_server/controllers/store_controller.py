...
def get_inventory():  # noqa: E501
    """Returns coffee inventories by status
...
def get_order_by_id(order_id):  # noqa: E501
    ...
    :param order_id: ID of coffee that needs to be fetched
    :type order_id: int
...
def place_order(order):  # noqa: E501
    """Place an order for a coffee

     # noqa: E501

    :param order: order placed for purchasing the coffee
